...
class TeamDetailsScreenBody extends StatelessWidget {
  final Team team;
  const TeamDetailsScreenBody({super.key, required this.team});
        ...
        children: [
          TopImageContainer(
            favoriteItem: FavoriteItemModel(
                ...
                imageUrl: team.strBadge ?? team.strLogo ?? MyImages.emptyImage,
                category: "team"),
